class ChatService {
  Future<Map<String, dynamic>> fetchChatResponse(String text) async {
    ...
    Map<String, dynamic> response = {
      'products': products,
      'recommendation':
          'Based on your query, I recommend product4. It is best suited for Category 3 and priced at \$12.99. It has also been a bestseller in its catgory for over 4 months.',
    };
    return response;
  }
}
